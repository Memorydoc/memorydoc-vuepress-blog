...
const htmlModule: VdoingThemeConfig['htmlModules'] = {
  homeSidebarB:
    ...
    <p style="
      ...
      margin: 0 0 8px 0;
    ">联系作者</p>
    <img src="https://kevin-cloud-dubbo.oss-cn-beijing.aliyuncs.com/gobrs-async/1261646574221_.pic_hd.jpg?x-oss-process=image/resize,h_500,w_800"  style="width:100%;" />
    </div>`,
  // `<!-- 纵向自适应 -->
